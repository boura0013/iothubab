...
static const char g_DeviceModelId[] = "dtmi:septic:Septick3rv;1";
...
void setup() {
   ...
   IOTHUB_CLIENT_TRANSPORT_PROVIDER protocol = HTTP_Protocol;
    ...
    g_pnpDeviceConfiguration.modelId = g_DeviceModelId;
    g_pnpDeviceConfiguration.enableTracing = g_hubClientTraceEnabled;
    device_ll_handle = PnP_CreateDeviceClientLLHandle_ViaDps(&g_pnpDeviceConfiguration);
